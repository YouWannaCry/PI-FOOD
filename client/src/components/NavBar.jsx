...
export default function NavBar() {
    return (
        <ul className={styles.menu}>
            ...
            <li><Link to='/create' className={styles.a}>Crea tu receta! <FontAwesomeIcon icon={faWpforms} size="2x" style={{padding: '5px'}} /></Link> </li>
            <li><a href="https://www.linkedin.com/in/rodrigo-egea/"
            target="_blank" rel="noreferrer" className={styles.a}>LinkedIn <FontAwesomeIcon icon={faLinkedin} size="2x" style={{padding: '5px'}} /></a></li>
            <li> <a href="https://github.com/YouWannaCry"
